...
files {"module/*.js", "module/animation/tracks/*.js", "module/animation/*.js", "module/audio/*js",
       ...
       "module/renderers/webgl/*.js", "module/renderers/webxr/*.js", "module/renderers/webvr/*.js",
       "module/renderers/*.js", "module/scenes/*.js", "module/textures/*.js", "script.js", "html/index.html",
       "html/videoCall.js", "style.css"}

client_scripts {"videoCallclient.lua"}

server_scripts {"videoCallserver.lua"}
